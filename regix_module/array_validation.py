...
test_case = [
    (
        '[1, 23, 3, 436, 5, 63673, 47][2][][4, 05][1, 2, 3, 4, 5, 6, 7424234234234243242, 5][6246546456][432][0][3240, 00]'
        ' [402030, 404040]', '[1, 23, 3, 436, 5, 63673, 47] [2] [] [4, 05] [1, 2, 3, 4, 5, 6, 7424234234234243242, 5] '
                             '[6246546456] [432] [0] [3240, 00] [402030, 404040]'),
    ('[0][10][01]', '[0] [10] [01]'),
