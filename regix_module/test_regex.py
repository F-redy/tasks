...
def test_regex(test_case: list[any], pattern: str, method: str, replace_group: str = None, flags: int = 0) -> None:
    """
    ...
    :param replace_group: Optional. The name of the capturing group.
    ...
    for i, (test, answer) in enumerate(test_case, 1):
        ...
        if replace_group:
            result = regex_method(pattern, replace_group, test, flags=flags)
        else:
